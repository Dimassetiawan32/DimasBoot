...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel navbar-primary bg-primary">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link font-weight-bold">Documentation</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link font-weight-bold">Examples</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link font-weight-bold">Icons</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link font-weight-bold">Themes</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link font-weight-bold">Expo</a>
                        </li>
                        <li class="nav-item">
                            <a href="" class="nav-link font-weight-bold">Blog</a>
                        </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-md-right" aria-labelledby="bd-versions">
                                ...
                                <a class="dropdown-item" href="">v3.4.1</a>
